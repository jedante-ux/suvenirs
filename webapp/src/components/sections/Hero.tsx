...
export default function Hero() {
  ...
  return (
    <section className="relative pt-16 md:pt-20 overflow-hidden hero-animated-bg">
      ...
      <div className="absolute inset-0" aria-hidden="true" style={{ background: 'conic-gradient(from 0deg, #E91E91, #F47920, #D3DC2A, #F47920, #E91E91)', animation: 'heroRotate 25s ease-in-out infinite' }} />
